...
<div id="accessibility-shortcuts" class="hide">
	<ul>
		...
		<div class="off-canvas-content" data-off-canvas-content>
			...
			<header class="container-masthead">
				<!-- <div class="row">
					...
					<h1 class="logo"><a href="http://i.gov.ph/" title="iGovPhil Program" rel="home"><img src="http://i.gov.ph/wp-content/uploads/2017/04/logo-masthead-large_iGov_April-2017.png"></a></h1>
					</div>

					<div class="large-3 columns">
					<div id="text-4" class="ear-content widget widget_text" style="text-align: center;">			<div class="textwidget"><a href="http://i.gov.ph/transparency"><img id="tp-seal" src="http://i.gov.ph/wp-content/uploads/2016/04/transpa.png" alt="transparency seal logo" title="Transparency Seal"></a></div>
					</div>
					</div>
					<p class="hide" id="pst-time"></p>
